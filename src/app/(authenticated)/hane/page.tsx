    ...
    <div className="max-w-4xl mx-auto px-8 pt-32 pb-24">
      <div className="flex items-end justify-between mb-12 gap-6">
        <div>
          ...
          <h1 className="font-heading text-5xl lg:text-6xl font-extrabold tracking-tighter leading-[1.05]">Hanem</h1>
          <p className="text-text-secondary text-lg mt-3">Aile ve ev arkadaşlarınla mutfağı paylaş.</p>
        </div>
        <button onClick={() => setShowCreate(true)} className="flex items-center gap-2 px-6 py-3.5 rounded-xl bg-primary-container text-text font-heading font-extrabold text-xs uppercase tracking-[0.15em]">
