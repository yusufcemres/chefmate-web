  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-8 pt-32 pb-24">
      <div className="mb-12 max-w-3xl">
        ...
        <h1 className="font-heading text-5xl lg:text-6xl font-extrabold tracking-tighter leading-[1.05] mb-4">Sana Özel</h1>
        <p className="text-text-secondary text-lg">Stoğuna ve tercihlerine göre AI önerileri.</p>
      </div>
